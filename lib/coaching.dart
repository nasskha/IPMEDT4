        ...
        child: Column(
          children: [
            SubscriptionCard(
              title: 'Basic Package',
              description:
              'Een keer per maand online coaching + toegang tot beperkte aantal mental health artikelen.',
              price: '€9.99',
            ...
            SubscriptionCard(
              title: 'Pro Package',
              description:
              'Een keer per week online coaching + toegang tot alle mental health artikelen.',
              price: '€19.99',
              buttonColor: buttonColor,
              cardColor: widgetColor, // Set the card color to widgetColor
            ),
            SubscriptionCard(
              ...
              description:
              'Dagelijks online coaching + toegang tot alle mental health artikelen + cursussen en trainingen over stressmanagement + kortingen op supplementen.',
              price: '€39.99',
              buttonColor: buttonColor,
              cardColor: widgetColor, // Set the card color to widgetColor
            ),
...
class SubscriptionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      shadowColor: Colors.grey[400], // Set shadow color
      child: Padding(
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(
                  elevation: 8, // Increase elevation for button
